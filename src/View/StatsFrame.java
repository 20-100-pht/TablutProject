...
public class StatsFrame extends Frame {
    ...
    private void loadAssets() {
        try{
            imageLeftArrow = new ImageIcon(ImageIO.read(new File("images/arrow4_left.png")));
            imageRightArrow = new ImageIcon(ImageIO.read(new File("images/arrow4_right.png")));
            imageCross = new ImageIcon(ImageIO.read(new File("images/cross2.png")));
            imageVal = new ImageIcon(ImageIO.read(new File("images/val.png")));
