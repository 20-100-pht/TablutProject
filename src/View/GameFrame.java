...
public class GameFrame extends Frame {
    ...
    void loadAssets(){
        try{
            imageRobot = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/robot.png")));
            imageHuman = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/human.png")));
            imageArrowLeft = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/arrow3_left.png")));
            imageArrowRight = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/arrow3_right.png")));
            imageArrowLeft2 = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/arrow5_left.png")));
            imageArrowRight2 = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/arrow5_right.png")));
            imageBook = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/book.png")));
            imageBulb = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource("images/bulb.png")));
            imageMenu = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource( "images/menu_icon.png")));
            imageMenu2 = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource( "images/menu_icon2.png")));
            imageBackground = ImageIO.read(ClassLoader.getSystemClassLoader().getResource( "images/backgroundMenu.jpg"));
            imageBackground2 = ImageIO.read(ClassLoader.getSystemClassLoader().getResource( "images/bg_theme_simple.jpg"));
            imageStartE = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource( "images/startE.png")));
            imageStartF = new ImageIcon(ImageIO.read(ClassLoader.getSystemClassLoader().getResource( "images/startF.png")));
    ...
    public void adaptWindow(){
        ...
        window.setMinimumSize(new Dimension(1000, 815));
